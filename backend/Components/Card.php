...
final class Card
{
    ...
    public function renderCard() {
        ...
        class="card w-72 max-h-80 rounded-md flex flex-col justify-around items-center bg-slate-200 p-2 shadow-gray-500 shadow hover:bg-slate-300 hover:shadow-gray-700">';
        
        $card .= '<input type="hidden" name="id" value="'. $this->data['id'].'">'; 
        
            $card .= '<img src=' . $this->data['imagem'] .' alt="Foto do móvel '. $this->data['nome'] .'" class="w-full max-h-60">';
